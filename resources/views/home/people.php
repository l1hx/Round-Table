<link href="<?php echo cdn('/css/home-people.css'); ?>" media="screen" rel="stylesheet" type="text/css" />
<div class="row-fluid">
    ...
    <div id="main-content" class="span9">
        ...
        <div class="profile">
            <div class="avatar" style="background: <?php echo $colors[rand(0, 3)]; ?>">
                <img src="<?php echo cdn('/img/silhouette.png'); ?>" alt="avatar" />
            </div> <!-- .avatar -->
...
<script type="text/javascript">
    $.getScript('<?php echo cdn('/js/md5.js'); ?>', function() {
