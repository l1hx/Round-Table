<link href="<?php echo cdn('/css/home-votes.css'); ?>" media="screen" rel="stylesheet" type="text/css" />
<link href="<?php echo cdn('/css/bootstrap.datetimepicker.min.css'); ?>" media="screen" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="<?php echo cdn('/js/raphael-2.1.2.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo cdn('/js/raphael-pie-chart.js'); ?>"></script>
